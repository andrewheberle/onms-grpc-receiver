bsm/bsm.pb.go: proto/bsm.proto
	protoc --proto_path=proto --go_out=pkg/bsm --go_opt=paths=source_relative --go_opt=Mmonitored-services.proto=github.com/andrewheberle/onms-grpc-receiver/pkg/bsm monitored-services.proto
